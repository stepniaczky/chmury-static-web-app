...
{
  /* <div>
  <div className=" max-xl:w-full max-xl:flex max-xl:justify-center mt-5 mx-2.5">
    <Card
      imgSrc="https://thebrobarbershop.pl/wp-content/uploads/2019/02/salon.jpg"
      className="border-neutral-800 max-xl:max-w-sm lg:"
    >
      <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
        Wiele salonów w Polsce
      </h5>
  ...
  <div className="lg:float-left max-lg:w-full max-lg:flex max-lg:justify-center mt-5 mx-2.5">
    <Card
      imgSrc="https://d-pa.ppstatic.pl/frames/pa-def/c6/b5/il20220715_726631185_large.jpg"
      className="border-neutral-800 max-lg:max-w-sm"
    >
      <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
        Profesjonalne salony
      </h5>
